    ...
    if (subcommand === "status") {
      ...
      try {
        ...
        const embed = new EmbedBuilder()
          .setColor("#1DB954")
          .setTitle(`${e("HEADPHONES")} Spotify Integration Status`)
          .addFields(
            {
              name: `${e("SUCCESS")} Authentication`,
              value: "Connected successfully",
              inline: true,
            },
            {
              name: "🔑 Client ID",
              value: `${process.env.SPOTIFY_CLIENT_ID.substring(0, 8)}...`,
              inline: true,
            },
            {
              name: `${e("MUSIC")} Features`,
              value: "Tracks, Playlists, Albums",
              inline: true,
            },
          )
